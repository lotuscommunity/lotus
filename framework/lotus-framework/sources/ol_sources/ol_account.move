module lotus_framework::ol_account {
    ...
    friend lotus_framework::multi_action;
    friend lotus_framework::burn;
    friend lotus_framework::safe;
    friend diem_framework::genesis;
    friend diem_framework::transaction_fee;
    friend lotus_framework::genesis_migration;
    friend lotus_framework::rewards;

    #[test_only]
    friend lotus_framework::test_multi_action;
    #[test_only]
  ...
  fun maybe_update_burn_tracker_impl(addr: address) acquires BurnTracker {
    ...
    #[test(root = @lotus_framework, alice = @0xa11ce, core = @0x1)]
    ...
    acquires BurnTracker {
        ...
        lotus_framework::lotus_coin::initialize_for_test(core);
    ...
    #[test(root = @lotus_framework, from = @0x123, core = @0x1, recipient_1 = @0x124, recipient_2 = @0x125)]
    ...
    #[test(root = @lotus_framework, user = @0x123)]
