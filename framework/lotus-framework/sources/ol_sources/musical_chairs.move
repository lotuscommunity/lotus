module lotus_framework::musical_chairs {
  ...
  const MINIMUM_ROUNDS_PER_EPOCH: u64 = 1000;
    ...
    public(friend) fun initialize(
        ...
        if (exists<Chairs>(@lotus_framework)) {
            return
        };
    ...
    public(friend) fun stop_the_music( // sorry, had to.
        ...
        let chairs = borrow_global_mut<Chairs>(@lotus_framework);
    ...
    public fun get_current_seats(): u64 acquires Chairs {
        borrow_global<Chairs>(@lotus_framework).seats_offered
    }
