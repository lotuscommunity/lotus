...
module lotus_framework::genesis_migration {
  use std::signer;
  use std::error;
  ...
  #[test_only]
  friend lotus_framework::test_migration;
  ...
  to_escrow: u64, lifetime_pledged: u64, lifetime_withdrawn: u64) {
    ...
    pledge_accounts::migrate_pledge_account(framework_sig, user_sig, @lotus_framework, c, lifetime_pledged,
    lifetime_withdrawn);
  }
}
