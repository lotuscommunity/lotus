...
module lotus_framework::burn {
  ...
  use lotus_framework::coin::{Self, Coin};
  use lotus_framework::match_index;
  use lotus_framework::fee_maker;
  // use lotus_framework::Debug::print;

  friend diem_framework::genesis;

  friend lotus_framework::epoch_boundary;
  friend lotus_framework::pledge_accounts;
  friend lotus_framework::make_whole;

  #[test_only]
  friend lotus_framework::test_burn;
  #[test_only]
  friend lotus_framework::test_rewards;
  #[test_only]
  ...
  public(friend) fun burn_and_track(coin: Coin<LotusCoin>) acquires BurnCounter {
    ...
    let state = borrow_global_mut<BurnCounter>(@lotus_framework);
    coin::user_burn(coin);
  ...
  public fun get_lifetime_tracker(): (u64, u64) acquires BurnCounter {
    let state = borrow_global<BurnCounter>(@lotus_framework);
