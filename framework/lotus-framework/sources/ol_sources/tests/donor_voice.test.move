...
module lotus_framework::test_donor_voice {
  use lotus_framework::ballot;
  use lotus_framework::donor_voice;
  use lotus_framework::donor_voice_txs;
  use lotus_framework::mock;
  use lotus_framework::ol_account;
  use lotus_framework::multi_action;
  use lotus_framework::receipts;
  use lotus_framework::donor_voice_governance;
  use lotus_framework::community_wallet_init;
  use lotus_framework::community_wallet;
  ...
  use diem_std::debug::print;
    ...
    #[test(root = @lotus_framework, alice = @0x1000a, bob = @0x1000b, carol = @0x1000c, marlon_rando = @0x123456)]
    ...
    #[test(root = @lotus_framework, alice = @0x1000a, bob = @0x1000b, carol = @0x1000c, dave = @0x1000d, marlon_rando = @0x123456)]
    ...
    #[test(root = @lotus_framework, _alice = @0x1000a, dave = @0x1000d, eve = @0x1000e, donor_voice = @0x1000f)]
    ...
    #[test(root = @lotus_framework, alice = @0x1000a, dave = @0x1000d, eve = @0x1000e)]
    ...
    #[test(root = @lotus_framework, community = @0x10011, alice = @0x1000a, bob = @0x1000b, carol = @0x1000c)]
