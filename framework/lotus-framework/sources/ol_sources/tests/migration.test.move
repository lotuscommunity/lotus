#[test_only]
module lotus_framework::test_migration {
  use lotus_framework::genesis_migration;
  ...
  #[test(root = @lotus_framework, user = @0xaaaaaa)]
  ...
  // #[test(root = @lotus_framework, marlon_rando = @0x123456)]
