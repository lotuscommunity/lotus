...
module lotus_framework::test_reconfiguration {
  use std::vector;
  ...
  fun reconfig_reward_happy_case(root: signer) {
      ...
      // let alice_bal = lotus_coin::balance(@0x1000a);
  ...
  fun drop_non_performing(root: signer) {
      ...
      mock::pof_default();
      assert!(lotus_coin::balance(@0x1000a) == 0, 7357000);
      ...
      assert!(lotus_coin::balance(@0x1000a) == 0, 7357005);
      // bob does
      assert!(lotus_coin::balance(@0x1000b) == (reward - entry_fee), 7357006);
