#[test_only]
module lotus_framework::test_multi_action_migration {
    use lotus_framework::mock;
    use lotus_framework::multi_action;
    use lotus_framework::multi_action_migration;
    use std::signer;
    use std::option;
    use std::vector;
    ...
    #[expected_failure(abort_code = 0x80001, location = lotus_framework::multi_action_migration)]
    ...
    #[test(root = @lotus_framework, alice = @0x1000a)]
    #[expected_failure(abort_code = 0x30003, location = lotus_framework::multi_action_migration)]
    ...
    #[test(root = @lotus_framework, alice = @0x1000a, bob = @0x1000b)]
    #[expected_failure(abort_code = 0x50002, location = lotus_framework::multi_action_migration)]
    ...
    #[test(root = @lotus_framework, alice = @0x1000a)]
    #[expected_failure(abort_code = 0x30004, location = lotus_framework::multi_action_migration)]
