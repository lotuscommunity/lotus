...
module lotus_framework::test_safe {
  ...
  #[test(root = @lotus_framework, alice = @0x1000a, bob = @0x1000b, dave = @0x1000d )]
  ...
  #[test(root = @lotus_framework, alice = @0x1000a, bob = @0x1000b, carol = @0x1000c, eve = @0x1000e)]
