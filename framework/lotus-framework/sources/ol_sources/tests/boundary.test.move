...
#[test_only]
module lotus_framework::test_boundary {
  use std::vector;
  use std::features;
  ...
  use lotus_framework::epoch_boundary;
  use lotus_framework::block;
  ...
  #[test(root = @lotus_framework, alice = @0x1000a,  marlon_rando = @0x12345)]
  ...
  #[test(root = @lotus_framework, marlon = @0x12345)]
  ...
  // #[test(root = @lotus_framework, alice = @0x1000a, marlon = @0x12345)]
