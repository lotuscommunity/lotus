...
#[test_only]
module lotus_framework::test_burn {
  ...
  fun burn_changes_real_balance(root: &signer, alice: &signer) {
    ...
    #[test(root = @lotus_framework, alice = @0x1000a, bob = @0x1000d, eve = @0x1000e)]
  ...
  #[test(root = @lotus_framework, alice_val = @0x1000a)]
