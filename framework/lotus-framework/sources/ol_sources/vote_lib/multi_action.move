...
module lotus_framework::multi_action {
    use std::vector;
    ...
    friend lotus_framework::multi_action_migration;

    #[test_only]
    friend lotus_framework::test_multi_action_migration; // TODO: remove after offer migration
