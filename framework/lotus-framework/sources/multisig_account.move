...
module diem_framework::multisig_account {
    ...
    fun create_multisig_account(owner: &signer): (signer, SignerCapability) {
        ...
        // flow.
        lotus_coin::maybe_register(&multisig_signer);
        // if (!coin::is_account_registered<LotusCoin>(address_of(&multisig_signer))) {
        //     coin::register<LotusCoin>(&multisig_signer);
        // };
