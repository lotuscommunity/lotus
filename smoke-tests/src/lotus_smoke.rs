...
impl LotusSmoke {
    ...
    pub async fn new_with_target(
        ...
        for &validator_address in &validator_addresses {
            ...
            helpers::mint_lotus(&mut pub_info, validator_address, 1000 * 1_000_000)
                .await
                .context("could not mint to account")?;
            helpers::unlock_lotus(&mut pub_info, validator_address, 1000 * 1_000_000)
                .await
    ...
    pub async fn mint_and_unlock(
        ...
        helpers::mint_lotus(&mut pub_info, addr, amount).await?;
